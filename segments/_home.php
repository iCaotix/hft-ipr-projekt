  ...
  <div class="row">
    <div class="col-12">
      <div class="card-columns">
          ...
          <blockquote class="blockquote mb-0 card-body">
            ...
            <footer class="blockquote-footer">
              <small class="text-muted">
                <a style="color: grey;" href="www.loremipsum.de">www.loremipsum.de</a>
              </small>
            </footer>
          </blockquote>
        </div>
        ...
        <div class="card p-3 bg-info text-white text-right">
          <blockquote class="blockquote mb-0">
            <p>We are online since 21.06.2018</p>
            <footer class="blockquote-footer">
              <small class="text-muted">
                FriendsBook
              </small>
        ...
        <div class="card p-3 bg-secondary text-white">
          <blockquote class="blockquote mb-0 card-body">
            ...
            <footer class="blockquote-footer">
              <small class="text-muted">
                <a style="color: white;" href="www.loremipsum.de">www.loremipsum.de</a>
              </small>
            </footer>
          </blockquote>
        </div>
